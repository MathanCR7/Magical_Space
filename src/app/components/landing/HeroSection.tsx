...
// --- SLIDES DATA ---
// Added a description for more content richness
const slides = [
  {
    id: 1,
    title: 'Modern Living',
    ...
    image: 'https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&w=2070&q=80',
  },
  {
    id: 2,
    ...
    image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=2070&q=80',
  },
  {
    id: 3,
    ...
    image: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?auto=format&fit=crop&w=2070&q=80',
  },
];

// --- ANIMATION VARIANTS ---
// FIX: Apply the 'Transition' type to the transition constant
...
const CTAButton = () => {
    ...
    return (
        <button className="relative w-40 h-40 md:w-48 md:h-48 flex items-center justify-center group z-50">
            <motion.div
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black text-white flex flex-col items-center justify-center font-sans">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center w-full h-full max-w-7xl mx-auto px-5 md:px-10">
        ...
        {/* Right Side: Foreground Image Portal & CTA on mobile */}
        <div className="relative w-full h-full flex flex-col items-center justify-center lg:justify-end">
            ...
            {/* CTA for mobile, hidden on larger screens */}
      ...
      {/* CTA for desktop, hidden on smaller screens */}
      <div className="hidden lg:block absolute z-20 top-[15%] right-[5%] md:top-auto md:bottom-10 md:right-[8.5rem] opacity-80 hover:opacity-100 transition-opacity">
        <CTAButton />
      </div>
